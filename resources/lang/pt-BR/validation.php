...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'subjects'              => 'Assunto',
        'phone_1'               => 'Telefone',
        'smartphone_1'          => 'Celular',
        'address_zipcode'       => 'CEP',
        'address_number'        => 'Número',
        'address_neighb'        => 'Bairro',
        'address_city'          => 'Cidade',
        'address_state'         => 'Estado/UF',
        'birth_day'             => 'Data de Nascimento',
        'rg_number'             => 'Número do RG',
        'rg_exp'                => 'Órgão Expedidor',
        'rg_date_exp'           => 'Data da expedição do RG',
        'profession'            => 'Profissão',
        'school_level'          => 'Escolaridade',
        'school_conclusion_year'  => 'Ano de Conclusão',
        'school_institute'       => 'Instituição de Ensino',
        'category_id'           => 'Categoria/Tipo do curso',
        'label'                 => 'url',
        'responsibility'        => 'Responsabilidade/Função',
        'responsible_name'      => 'Nome do Responsável',
        'price_standard'        => 'Preço padrão',
        'about_course'          => 'Informações sobre o curso',
        'overview_course'       => 'Panorama do Curso',
